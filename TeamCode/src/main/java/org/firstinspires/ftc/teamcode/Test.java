...
public class Test extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            double frontLeftMotorPower = (y + x + rx * 0.7) / denominator;
            double frontRightMotorPower = (y - x - rx * 0.7) / denominator;
            double backLeftMotorPower = (y - x + rx * 0.7)/ denominator;
            double backRightMotorPower = (y + x - rx * 0.7) / denominator;
